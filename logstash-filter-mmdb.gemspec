...
Gem::Specification.new do |s|
  s.name            = 'logstash-filter-mmdb'
  s.version         = ::File.read('VERSION').split('\n').first
  s.licenses        = ['Apache-2.0']
  s.summary         = 'Logstash filter plugin for querying custom MMDB databases'
  s.description     = 'This gem is a Logstash plugin required to be installed on top of the Logstash core pipeline using $LS_HOME/bin/logstash-plugin install gemname. This gem is not a stand-alone program'
  s.authors         = ['Cameron Kerr']
  s.email           = ['cameron.kerr.nz@gmail.com']
  s.homepage        = 'http://github.com/cameronkerrnz/logstash-filter-mmdb/'
